...
function onBuyClicked() {
  if (!window.PaymentRequest) {
    document.getElementById('url').value = "Web payments are not supported in this browser.";
  ...
  try {
    ...
    document.getElementById('url').value = e.message;
...
function redirectToPlayStore() {
  console.log("had to redirect sorry!");
